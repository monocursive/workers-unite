defmodule Forgelet.Accounts do
  @moduledoc """
  ...
  alias Forgelet.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Forgelet.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Forgelet.Accounts.User.password_changeset/3` for a list of supported options.
  ...
  @doc """
  Generates a one-time login token for the user (e.g. for onboarding redirect).
