defmodule Forgelet.Control.Node do
  @moduledoc """
  ...
  schema "control_nodes" do
    ...
    has_many :job_runs, Forgelet.Control.JobRun, foreign_key: :worker_id
    has_many :job_leases, Forgelet.Control.JobLease, foreign_key: :worker_id
