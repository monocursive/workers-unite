defmodule Forgelet.Consensus.Engine do
  @moduledoc """
  ...
  alias Forgelet.Consensus.Policy
  ...
  def init(_opts) do
    ...
    default_policy = Application.get_env(:forgelet, :default_consensus_policy, {:threshold, 0.5})
