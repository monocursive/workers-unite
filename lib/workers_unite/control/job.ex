defmodule WorkersUnite.Control.Job do
  @moduledoc """
  ...
  schema "control_jobs" do
    ...
    belongs_to :workflow, WorkersUnite.Control.Workflow
    has_many :runs, WorkersUnite.Control.JobRun
    has_one :lease, WorkersUnite.Control.JobLease
