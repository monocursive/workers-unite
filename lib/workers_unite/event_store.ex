defmodule WorkersUnite.EventStore do
  @moduledoc """
  ...
  alias WorkersUnite.{Event, EventRecord, Repo, Schema}

  @default_table :workers_unite_events
  ...
  defp broadcast(event) do
    Phoenix.PubSub.broadcast(WorkersUnite.PubSub, "events", {:event, event})
    Phoenix.PubSub.broadcast(WorkersUnite.PubSub, "events:kind:#{event.kind}", {:event, event})
