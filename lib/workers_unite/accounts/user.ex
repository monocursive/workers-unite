defmodule WorkersUnite.Accounts.User do
  @moduledoc """
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, WorkersUnite.Repo)
  ...
  def onboarding_completed?(%__MODULE__{onboarding_completed_at: _}), do: true
  ...
  """
  def valid_password?(%WorkersUnite.Accounts.User{hashed_password: hashed_password}, password)
