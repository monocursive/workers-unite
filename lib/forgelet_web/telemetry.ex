defmodule ForgeletWeb.Telemetry do
  ...
  def metrics do
    [
      ...
      # Database Metrics
      summary("forgelet.repo.query.total_time",
        unit: {:native, :millisecond},
        description: "The sum of the other measurements"
      ),
      summary("forgelet.repo.query.decode_time",
        unit: {:native, :millisecond},
        description: "The time spent decoding the data received from the database"
      ),
      summary("forgelet.repo.query.query_time",
        unit: {:native, :millisecond},
        description: "The time spent executing the query"
      ),
      summary("forgelet.repo.query.queue_time",
        unit: {:native, :millisecond},
        description: "The time spent waiting for a database connection"
      ),
      summary("forgelet.repo.query.idle_time",
        unit: {:native, :millisecond},
        description:
