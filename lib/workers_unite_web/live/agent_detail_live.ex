defmodule WorkersUniteWeb.AgentDetailLive do
  ...
  alias WorkersUnite.{Agent, EventStore, Identity}
    ...
    case Base.decode16(hex_id, case: :lower) do
      {:ok, public_key} ->
        if connected?(socket) do
          Phoenix.PubSub.subscribe(WorkersUnite.PubSub, "events:author:#{hex_id}")
        end
