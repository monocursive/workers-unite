defmodule WorkersUniteWeb.Telemetry do
  @moduledoc false
  ...
  def metrics do
    [
      ...
      # Database Metrics
      summary("workers_unite.repo.query.total_time",
        unit: {:native, :millisecond},
        description: "The sum of the other measurements"
      ),
      summary("workers_unite.repo.query.decode_time",
        unit: {:native, :millisecond},
        description: "The time spent decoding the data received from the database"
      ),
      summary("workers_unite.repo.query.query_time",
        unit: {:native, :millisecond},
        description: "The time spent executing the query"
      ),
      summary("workers_unite.repo.query.queue_time",
        unit: {:native, :millisecond},
        description: "The time spent waiting for a database connection"
      ),
      summary("workers_unite.repo.query.idle_time",
        unit: {:native, :millisecond},
        description:
